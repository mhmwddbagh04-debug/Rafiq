                  ...
                  children: [
                    ...
                    FutureBuilder<List<Category>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.hasData)
                          return _buildCircularCategories(
                            context,
                            snapshot.data!,
                            provider,
                          );
        ...
        TextButton(
          onPressed: () {
            Navigator.pushNamed(
              ...
              arguments: {'title': title, 'categoryId': null},
            );
          },
          child: Text(
            local.viewAll,
          ...
          return InkWell(
            onTap: () {
              ...
              Navigator.pushNamed(
                context,
                AppRouter.allProducts,
                arguments: {'title': category.name, 'categoryId': category.id},
              );
            },
            child: Column(
              children: [
